  ...
  return (
    <section className="relative bg-gradient-to-br from-indigo-50 via-white to-emerald-50 pt-32 pb-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center px-6">
        {/* Texto principal */}
        <div>
          <div className="inline-flex items-center gap-2 bg-white border border-[#4F46E5] text-[#4F46E5] px-4 py-2 rounded-full text-sm font-medium mb-6">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <Link
              href="/auth/register"
              className="px-8 py-4 bg-gradient-to-r from-[#4F46E5] to-[#10B981] text-white rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 font-semibold text-center flex items-center justify-center gap-2"
            >
            ...
            <Link
              href="#demo"
              className="px-8 py-4 border-2 border-[#4F46E5] text-[#4F46E5] rounded-lg hover:bg-indigo-50 transition-all font-semibold text-center flex items-center justify-center gap-2"
            >
        ...
        <div className="relative">
          <div className="absolute -inset-4 bg-gradient-to-r from-[#4F46E5] to-[#10B981] rounded-2xl opacity-20 blur-2xl" />
          ...
          <div className="absolute -bottom-6 -left-6 bg-white rounded-lg shadow-xl p-4 border border-gray-100">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-gradient-to-br from-[#4F46E5] to-[#10B981] rounded-lg flex items-center justify-center text-white font-bold text-lg">
                📈
              </div>
              <div>
          ...
          <div className="absolute -top-6 -right-6 bg-white rounded-lg shadow-xl p-4 border border-gray-100">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-gradient-to-br from-[#10B981] to-[#4F46E5] rounded-lg flex items-center justify-center text-white font-bold text-lg">
                ✓
              </div>
              <div>
